...
export default function SubmitSpinner() {
  ...
  if (toggleActivePage === "chart") {
    return (
        <Col className="gutter-row" xs={{ span: 24, push: 0}} sm={{ span: 6, push: 0}} xl={{ span: 4, push: 0}} style={{display:'flex', alignItems: 'flex-start', justifyContent: 'flex-end', height: 54 }}>
